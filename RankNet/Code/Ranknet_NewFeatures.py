...
def test():
    #test data
    test_path = '/media/jun/ubuntu/RankNet/RankNet-master2/Data/Fold5/newtest5.txt'
    # 超参
    inputs = 17
    hidden_size = 10
    outputs = 1
...
if __name__ == '__main__':
    ...
    #Read training data
    X_train, y_train, Query_id = readDataset('/media/jun/ubuntu/RankNet/RankNet-master2/Data/Fold5/newtrain5.txt')
